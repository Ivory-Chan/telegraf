...
func (a *Accumulator) SetExtinfo(interval time.Duration, tags map[string]string) {
	a.Interval = interval
	a.Tags = tags
}

func (a *Accumulator) Getinterval() time.Duration {
	return a.Interval
}

func (a *Accumulator) GetTags() map[string]string {
	return a.Tags
}
